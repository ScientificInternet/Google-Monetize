module github.com/ScientificInternet/Google-Monetize/services/batchopen
...
require (
	...
	github.com/ScientificInternet/Google-Monetize/pkg/eventbus v0.0.0-20250921095352-ef8078c06b83
